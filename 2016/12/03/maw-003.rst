...
constraints. There are a couple of ways doing so. 

- 1st solution satisfies 3.12.a
- 2nd, 3rd solutin satisfies 3.12.a and 3.12.b
...
.. note::
    ...
    a list: in my case, :ref:`initializeList <maw-002>`.

.. admonition:: TODO 

    Will the newly allocated memory inside function creates any memory inefficiency?
...
- We use a private function mainly because we have *dummy* node in our implementation.
  ...
  there is *dummy* node exists in the sub list we passed in. Read Line[6] & Line[11]
  &  Line[16] to see why.
